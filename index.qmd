...
author: "Rick Gilmore"
institute: "Penn State Psychology & [Databrary](https://databrary.org)"
format: 
  revealjs:
    theme: default
    chalkboard: true
...
- Are you fooling yourself? Are others? How do we avoid that?
...
>"The flexibility of analytical approaches is exemplified by the fact that **no two teams chose identical workflows** to analyse the data. This flexibility resulted in **sizeable variation in the results of hypothesis tests**, even for teams whose statistical maps were highly correlated at intermediate stages of the analysis pipeline...Our findings show that **analytical flexibility can have substantial effects on scientific conclusions**...The results emphasize the **importance of validating and sharing complex analysis workflows**, and demonstrate the need for performing and reporting multiple analyses of the same data." [@Botvinik-Nezer2020-wr]

## Reactions to a many analysts approach

- How could a 'many analysts' approach be helpful/harmful?
- How does a 'many analysts' approach contradict conventional thinking?
